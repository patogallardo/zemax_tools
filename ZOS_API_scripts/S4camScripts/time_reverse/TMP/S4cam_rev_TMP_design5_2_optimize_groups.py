...
for j, group_leader in progressbar(enumerate(group_leaders)):
    ...
    # diagnostic lyot stop health, Deleted for new MF
#    mfe.GetOperandAt(7).GetOperandCell(3).IntegerValue = int(group_leader)
#    mfe.GetOperandAt(14).GetOperandCell(3).IntegerValue = int(group_leader)
    ...
    set_variables_or_const([prism_row1, prism_row2],
                           group_leader,
                           mce, ZOSAPI, vars=True)
